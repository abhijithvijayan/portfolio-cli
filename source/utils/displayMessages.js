 ...
 */
function showInitialCommandsToUser({destination, directory}) {
  console.log(chalk(`Initialized a git repository.`));
  console.log();
  console.log(
    chalk(
      `Success! Created ${directory} at ${destination}\nInside that directory, you can run several commands:`
    )
  );
  console.log();
  ...
  console.log(
    chalk(`    Bundles the app into static files using Next.js static exports.`)
  );
  console.log();
  console.log(chalk(`We suggest that you begin by typing:`));
  console.log();
  console.log(chalk(`  ${chalk.cyan.bold(`cd`)} ${directory}`));
...
function showFinalInstructionsToUser() {
  ...
  console.log(
    chalk(
      `   Do not delete or modify the \`${chalk.cyan.bold(
        `portfolio-cli.json`
      )}\` file`
    )
  );
  ...
  console.log(
    chalk(
      `What's Next? We suggest that you read the instructions in ${chalk.cyan.bold(
        `README.md`
      )} to get started.`
    )
  );
  ...
  console.log(
    chalk(
      `Want to create remote repo for this as well? Run \`${chalk.cyan.bold(
        `npx create-remote-repo portfolio`
      )}\``
    )
  );
}
...
function showDeploymentConfigMessages() {
  console.log();
  console.log(
    chalk(`Success! Deployment configuration file for Travis CI created.`)
  );
  console.log();
  console.log(
    chalk.cyan.bold(
      `Now, sync repository with Travis CI at https://travis-ci.com/ to start deploying`
    )
  );
}
