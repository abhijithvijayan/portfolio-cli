...
const deleteStrayFilesAndFolders = async () => {
	...
	if (fs.existsSync('public/manifest.json')) {
		await writeFileAsync('public/manifest.json', JSON.stringify(sampleManifestContent, null, 2));
	}
	...
	if (fs.existsSync('package.json')) {
		...
		fileContent.description = 'My Portfolio Website, generated by abhijithvijayan-portfolio';
